<div id='desktop'>
    ...
    <p class="text-center features">
        <img class="main-scheme" src="../img/svg/main-scheme.svg" alt="scheme"/>
        <img width="296" height="296" class="rounded-ui" src="../img/rounded-ui.png" alt="ui"/>
        <img width="68" class="icon desk-pencil" src="../img/svg/pencil.svg" alt="pencil"/>
        <span class="">Новый дизайн с красивой анимацией</span>
        <img width="68" class="icon desk-svg" src="../img/svg/svg.svg" alt="svg"/>
        <span>Почти вся графика векторная и не зависит от разрешения</span>
        <img width="64" class="icon desk-settings" src="../img/svg/settings.svg" alt="settings"/>
        <span>Добавлена возможность настраивать пароль</span>
        <img width="60" class="icon desk-apple" src="../img/svg/apple.svg" alt="apple"/>
    ...
    <div class="row versions">
        <div class="col-4">
            <a href="/1"><img height="198" src="../img/svg/v1.svg" alt="scheme"/></a>
            <h2>2011</h2>
            <ol>
        ...
        <div class="col-4">
            <a href="/2"><img height="198" src="../img/svg/v2.svg" alt="scheme"/></a>
            <h2>2012</h2>
            <ol>
        ...
        <div class="col-4">
            <a href="/3"><img height="198" src="../img/svg/v3.svg" alt="scheme"/></a>
            <h2>2013</h2>
            <ol>
    ...
    <div class="footer">
        ...
        <p class="social">
            <a href="https://github.com/nikbelikov/passgenius.ru" target="_blank"><img width="40" src="../img/svg/github.svg" alt="github"></a>
            <a href="https://twitter.com/_nikbelikov" target="_blank"><img width="45" src="../img/svg/twitter.svg" alt="github"></a>
            <a href="mailto:nikbelikov@me.com"><img width="55" src="../img/svg/mail.svg" alt="github"></a>
        </p>
        <p class="text-center">
